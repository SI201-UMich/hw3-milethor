# Name: Miles Thornton
# Student ID: 4762 4083
# Email:milethor@umich.edu
...
class CouponDispenser:
    ...
    def __init__(self, coupon_cards):
        ...
        self.coupon_cards = coupon_cards        #init coupon_cards

        self.customer_roster = []             #init customer_roster

        self.issued_indices = []             #init issued_indices
    ...
    def issue_coupon(self, name):
        ...
        if name in self.coupon_cards:
            ...
            return f"That name already has coupon: {self.coupon_cards[coupon_index]}"
           
        if name not in self.coupon_cards:
    ...
    def distribute_session(self):
        ...
        while True:
            ...
            user_input = input(f"Round number{round_counter} - Enter a name (or comma separated list) or type 'show' or 'exit': ")
